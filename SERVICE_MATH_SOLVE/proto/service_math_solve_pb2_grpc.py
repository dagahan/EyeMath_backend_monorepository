...
class MathSolverStub(object):
    """Сервис с одним методом Solve
    """
...
class MathSolverServicer(object):
    """Сервис с одним методом Solve
    """
...
def add_MathSolverServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'mathsolve.MathSolver', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('mathsolve.MathSolver', rpc_method_handlers)
