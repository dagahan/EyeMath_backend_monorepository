...
from src.services.routers.latex.recognizer_router import get_recognizer_router
...
class Server:
    def __init__(self) -> None:
        ...
        self.app = FastAPI(
            title="recognizer",
            description="latex recognition service.",
            version="0.0.1"
        )
    ...
    async def _register_routes(self) -> None:
        ...
        '''
        self.app.include_router(get_recognizer_router(self.data_base))
