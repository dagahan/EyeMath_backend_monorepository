...
const (
	GRPCMathSolve_Metadata_FullMethodName = "/mathsolve.GRPC_math_solve/Metadata"
	GRPCMathSolve_Solve_FullMethodName    = "/mathsolve.GRPC_math_solve/Solve"
)
...
func (c *gRPCMathSolveClient) Metadata(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*MetadataResponse, error) {
	...
	err := c.cc.Invoke(ctx, GRPCMathSolve_Metadata_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GRPCMathSolve_Metadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GRPCMathSolve_Metadata_FullMethodName,
	}
