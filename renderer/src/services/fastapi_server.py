...
from src.services.routers.render.renderer_router import get_renderer_router
...
class Server:
    def __init__(self) -> None:
        ...
        self.app = FastAPI(
            title="renderer",
            description="latex render service.",
            version="0.0.1"
        )
    ...
    async def _register_routes(self) -> None:
        ...
        '''
        self.app.include_router(get_renderer_router(self.data_base))
